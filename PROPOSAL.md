...
Twitter Bot couldn't really achieve this interactive fiction stylization. Disallows world building and storytelling.
...
While Twine may not be the most technically complicated technology available, it will allow us to create an argument by pseudo narrating the world to players.
...
**Overall, I think this is a good start to a proposal, but I'm a little worried about the lack of discussion of how the game will work. There are a lot of different possible mechanics for how detection works (physical clues, interviews, etc). How do you plan to model that?**

**Might thinking about some games (say LucasArts-style adventure games or *Carmen Sandiego*, which foreground very different detection methods) might help clarify this.**

**For the mock-up, I want to see a description of the overall story, even if it's just one example of a walk-through, as well as some discussion of what choices the player can make.**